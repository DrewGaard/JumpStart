...
public class BulkingMuscleOptionPane extends GraphicsPane {
	...
	public BulkingMuscleOptionPane(MainApplication app) {
		...
		Title = new GLabel("Bulking: Please Select A Muscle Group", 200, 60);
